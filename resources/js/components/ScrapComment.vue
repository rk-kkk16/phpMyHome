...
export default {
    ...
    props: ['num', 'scrap_entry_id', 'myuser_id'],
    ...
    methods: {
        loadBefore() {
            ...
            let self = this;
            let url = '/api/scrap/comment/list/' + self.scrap_entry_id + '?page=' + self.page + '&num=' + self.num;
            axios.get(url)
        ...
        sendComment() {
            ...
            let self = this;
            let url = '/api/scrap/comment/add';
            let params = {
                scrap_entry_id: self.scrap_entry_id,
        ...
        deleteComment(cmnt_id) {
            let self = this;
            let url = '/api/scrap/comment/delete/' + cmnt_id;
            $('#loading').removeClass('hidden');
            axios.delete(url)
            .then(function(response) {
                $('#loading').addClass('hidden');
