...
class KaimonoController extends Controller
{
    ...
    public function index(Request $request) {
        // state, sort_key, sort_orderをrequestからとって渡す
        ...
        return view('app.kaimono.index', ['state' => $state, 'sort_key' => $sort_key, 'sort_order' => $sort_order, 'actives' => $actives]);
    }
}
